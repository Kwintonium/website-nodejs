      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-[2fr,1fr] gap-8 items-start">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              My expertise spans across data science, machine learning, and computer vision, with a particular focus on implementing state-of-the-art Large Language Models (VLMS/LLMs) for practical business applications. As a full-stack data scientist, I develop end-to-end solutions, from data acquisition and analysis to deploying models in production as scalable APIs.
            </p>
          </div>
