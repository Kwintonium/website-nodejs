      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-[2fr,1fr] gap-8 items-start">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              My expertise spans across AI, computer vision, and machine learning, with a particular focus on implementing state-of-the-art VLMs/LLMs for practical business applications. I lead a team of data scientists in developing innovative solutions that enhance manufacturing efficiency and streamline part procurement processes.
            </p>
          </div>
