        ...
        <div className="grid md:grid-cols-[2fr,1fr] gap-8 items-start">
          <div className="space-y-4">
            <p className="text-muted-foreground">
              I'm a Lead Senior Data Scientist at Sustainment, where I leverage cutting-edge AI to optimize manufacturing supply chains. With a background in both Mechanical Engineering and Data Science, I bring a unique perspective to solving complex technical challenges.
            </p>
            <p className="text-muted-foreground">
